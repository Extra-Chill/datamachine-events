...
class Filters {
	...
	/**
	 * Get filter options with taxonomy dependencies
	 *
	 * @param WP_REST_Request $request Request object with optional active filters and context.
	...
	public function get( WP_REST_Request $request ) {
		...
		$taxonomies_data = Taxonomy_Helper::get_all_taxonomies_with_counts( $active_filters, $dependencies );
