...
define('DATAMACHINE_EVENTS_VERSION', '0.8.39');
...
class DATAMACHINE_Events {
    ...
    public function init() {
        ...
        if (is_admin()) {
            ...
            // Instantiate TicketUrlMigration for one-time migration notice
            if (class_exists('DataMachineEvents\\Admin\\TicketUrlMigration')) {
                new \DataMachineEvents\Admin\TicketUrlMigration();
            }
        }
