...
define( 'DATAMACHINE_EVENTS_VERSION', '0.13.1' );
...
if ( defined( 'WP_CLI' ) && WP_CLI && file_exists( DATAMACHINE_EVENTS_PLUGIN_DIR . 'inc/Cli/TicketUrlResyncCommand.php' ) ) {
	require_once DATAMACHINE_EVENTS_PLUGIN_DIR . 'inc/Cli/TicketUrlResyncCommand.php';
...
class DATAMACHINE_Events {
	...
	private function load_data_machine_components() {
		...
		if ( file_exists( DATAMACHINE_EVENTS_PLUGIN_DIR . 'inc/Abilities/DuplicateDetectionAbilities.php' ) ) {
			require_once DATAMACHINE_EVENTS_PLUGIN_DIR . 'inc/Abilities/DuplicateDetectionAbilities.php';
